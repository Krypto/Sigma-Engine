...
namespace sig
{
	...
	public:
		...
		/**
		 * @brief Get Key state.
		 * @param keycode Key code (SDLK)
		 * @return True if the Key is continuously pressed, False otherwise.
		 */
		 ...
		 * @param mod Modifier code(s)
		 * @return True if the specified modifier is pressed
		 */
		static bool GetModifier(int mod);

		/**
		 * @brief Get Key state when the Key is Down.
		 * @param keycode Key code (SDLK)
		...
		/**
		 * @brief  Get Key state when the Key is Up.
		 * @param keycode Key code (SDLK)
		 ...
		 * @param btncode Button index (SDL)
		 * @return True if the mouse button is continuously pressed, False otherwise.
		 */
		static bool GetMouse(int btncode);

		/**
		 * @brief Get mouse Button state when the Button is Down.
		 * @param btncode Button index (SDL)
		 * @return True if the Button is Down, False otherwise.
		 */
		static bool GetMouseButtonDown(int btncode);

		/**
		 * @brief Get mouse Button state when the Button is Up.
		 * @param btncode Button index (SDL)
		 * @return True if the Button is Up, False otherwise.
		 */
		static bool GetMouseButtonUp(int btncode);
	...
	private:
		...
		static bool m_inputMouse[];
		static bool m_downMouse[];
		static bool m_upMouse[];
